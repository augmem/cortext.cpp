...
Examples:
  ...
  python scripts/centroid_vectors.py generate --ravdess-dir data/ravdess --models-dir models/imagebind

  # Generate C++ embedded vectors from .npy files
  python scripts/centroid_vectors.py embed

  # Validate centroids against held-out RAVDESS files
  python scripts/centroid_vectors.py validate --ravdess-dir data/ravdess --models-dir models/imagebind
"""
...
///
/// This file is generated by scripts/centroid_vectors.py embed.
...
def cmd_generate(args: argparse.Namespace) -> int:
    ...
    # Save metadata
    metadata = {
        "generated_by": "scripts/centroid_vectors.py generate",
