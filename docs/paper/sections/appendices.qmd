...
12. **Interrupt Abort (if allowed):** Mark a pending abort when an interrupt is permitted outside a flush/spike event. On the next signal, resume the accumulator if novelty < τ_novelty(F,S,T); otherwise reset to drop partial utterances.
