...
Not all tunables are derived from knobs. When a value is specified as a fixed constant, it is a deliberate invariant and should be treated as such across implementations. Core invariants include:
