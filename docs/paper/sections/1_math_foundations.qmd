...
temporal context vectors, association ordering, and explicit replay timestamps:
...
The prompt-facing output is then narrowed after graph, event-time recency,
affect, procedural, source-confidence, and context scoring:
...
boosts, source-confidence weights, durable-source floors, and text seed
thresholds are likewise derived from Focus, Sensitivity, and Stability in the
implementation rather than exposed as additional user settings.
