...
The final Candidate 34 synchronization completed a warning-clean native
...
durable SQLite profile. These checks establish current-source
equivalence and test health; they do not convert the failed flatness or
throughput ratios into passes.
