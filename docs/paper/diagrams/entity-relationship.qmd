...
Note: Consolidation summaries require Gemma (LiteRT-LM); there is no extractive
...
Note: Consolidation supports shallow (embedding-only) and deep (Gemma-backed)
phases; shallow creates ASSOCIATION centroids without blobs and attaches
existing LABEL nodes by embedding similarity.
