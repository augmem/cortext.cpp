...
Following Cowan\'s (2001) capacity constraints, working memory maintains a limited number of active items. Working memory holds coherent memories as defined in Section 4.4, preserving the full content and signal sequence:
...
memory.embedding ← e_rep \# representative embedding (Section 4.4.5)
...
write_exclusion_ts ← t_start \# start timestamp from Section 4.4.1
