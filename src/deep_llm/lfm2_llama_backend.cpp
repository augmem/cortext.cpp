...
BuildSummarySystemPrompt ()
{
  ...
  if (style == "fewshot_durable")
    {
      return std::string (
             ...
             + "Preserve durable facts about names, places, projects, goals, preferences, plans, blockers, and outcomes.\n"
               ...
               "Input excerpts:\n"
               "Excerpt 1:\n"
               "My name is Gabriel and I live in Chicago.\n"
               "Excerpt 2:\n"
               "Noted.\n"
               "Excerpt 3:\n"
               "I am debugging a SQLite migration for Cortext before the demo.\n"
               "Output summary:\n"
             + example_one_summary
             + "\n\n"
               "Example 2\n"
               "Input excerpts:\n"
               "Excerpt 1:\n"
               "My neighbor Sarah is helping with a housing application in Logan Square.\n"
               "Excerpt 2:\n"
               "Missing pay stubs are delaying the submission.\n"
               "Output summary:\n"
             + example_two_summary;
    }
  ...
  if (style == "fewshot_precision")
    {
      return std::string (
             ...
             + "Use 1-2 sentences.\n"
               ...
               "Input excerpts:\n"
               "Excerpt 1:\n"
               "Alice is leading the Acme pilot in Seattle.\n"
               "Excerpt 2:\n"
               "The customer needs SSO and audit exports before June.\n"
               "Output summary:\n"
  ...
  if (style == "transcript_fewshot")
    {
      return std::string ("Write a compact durable summary from input excerpts.\n")
             + format
             + "Use 1-2 sentences.\n"
               "Capture the durable facts across the whole transcript, not just the last turn.\n"
               "Prefer names, places, projects, deadlines, blockers, and outcomes.\n"
               "Use direct factual sentences.\n"
               "Do not use speaker-role language or prompt headers. Avoid 'Summary:', 'Final summary:', 'the user', 'the assistant', and meta narration.\n"
               "\n"
               "Example 1 excerpts:\n"
               "My name is Gabriel and I live in Chicago.\n"
               "Noted.\n"
  ...
  return std::string (
         ...
         + "Summarize the underlying facts and topics, not the mechanics of the conversation.\n"
           ...
           "If multiple excerpts restate the same fact, prefer the underlying fact itself instead of narrating who said it.\n"
  ...
  if (style == "fewshot_durable")
    {
      return "Extract labels, relations, and durable facts from the provided "
             ...
             "Examples:\n"
             "Text:\n"
             "My name is Gabriel. I live in Chicago.\n"
             "Noted. You are debugging a SQLite migration for "
             "Cortext.\n"
             ...
             "}\n"
             "Text:\n"
             "I need help getting ready for an interview tomorrow. I "
             "want more confidence and a clear explanation.\n"
             "We can prep the interview.\n"
  ...
  if (style == "fewshot_precision")
    {
      return "Extract labels, relations, and durable facts from the provided "
             ...
             "Examples:\n"
             "Text:\n"
             "My neighbor Sarah is helping me prepare documents for a "
             "housing application in Logan Square.\n"
             "We can organize the paperwork.\n"
             "{\"labels\":[\"Sarah\",\"housing application\",\"Logan Square\"],"
             "\"relations\":[],\"facts\":[]}\n"
             "Text:\n"
             "The explanation and support were useful, but my goal is a "
             "better interview plan.\n"
             "We'll focus on the interview plan.\n"
  ...
  if (style == "fewshot_durable")
    {
      return "Extract durable graph labels from the provided text.\n"
             ...
             "Text:\n"
             "My name is Gabriel. I live in Chicago.\n"
             "You are debugging a SQLite migration for Cortext.\n"
             "{\"labels\":[\"Gabriel\",\"Chicago\",\"SQLite migration\","
             "\"Cortext\"]}\n"
             "Text:\n"
             "I need help getting ready for an interview tomorrow. I "
