...
BuildTextPrompt (const std::string &text)
{
  return std::string (
      ...
      "\"object\" strings taken from the text. "
      "Fact predicates must be concrete verbs or attributes copied from the source; never use co_occurs, implies, contradicts, reinforces, causes, or similar_to as a fact predicate, and never repeat the subject as the object. "
