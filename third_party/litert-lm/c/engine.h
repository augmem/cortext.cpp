...
// Sets the number of CPU threads for the engine.
// Only applies when using the CPU backend.
//
// @param settings The engine settings.
// @param num_threads The number of CPU threads to use. Use 1 for single-threaded
//   execution. Use 0 or negative values for the default (typically 4 threads).
void litert_lm_engine_settings_set_num_cpu_threads(
